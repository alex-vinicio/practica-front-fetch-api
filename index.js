...
const setTodoList = async () => {
  ...
  var divContainer = document.getElementById("container-list-group");
        ...
        <div class="column-content">
            <div class="item-element" >
                <div class="item-element-content">
                    <h2>${element[1].description}</h2>
                </div>

                <div class="item-element-actions">
                    <button class="action-button">
                        <svg class="img-container" stroke="currentColor" fill="currentColor" stroke-width="0"
